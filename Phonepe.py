...
if select == "HOME":
    ...
    question= st.selectbox("Select the Question",[  "Q1. Transaction Amount and Count of Aggregated Insurance",
                                                    "Q2. Transaction Amount and Count of Map Insurance",
                                                    "Q3. Transaction Amount and Count of Top Insurance",
                                                    "Q4. Transaction Amount and Count of Aggregated Transaction",
                                                    "Q5. Transaction Amount and Count of Map Transaction",
                                                    "Q6. Transaction Amount and Count of Top Transaction",
                                                    "Q7. Transaction Count of Aggregated User",
                                                    "Q8. Registered users of Map User",
                                                    "Q9. App opens of Map User",
                                                    "Q10. Registered users of Top User",
                                                    ])
    
    if question == "Q1. Transaction Amount and Count of Aggregated Insurance":
    ...
    elif question == "Q2. Transaction Amount and Count of Map Insurance":
    ...
    elif question == "Q3. Transaction Amount and Count of Top Insurance":
    ...
    elif question == "Q4. Transaction Amount and Count of Aggregated Transaction":
    ...
    elif question == "Q5. Transaction Amount and Count of Map Transaction":
    ...
    elif question == "Q6. Transaction Amount and Count of Top Transaction":
    ...
    elif question == "Q7. Transaction Count of Aggregated User":

        st.subheader("TRANSACTION COUNT")
        top_chart_transaction_count("aggregated_user")

    elif question == "Q8. Registered users of Map User":
        
        states= st.selectbox("Select the State", Map_user["States"].unique())   
        st.subheader("REGISTERED USERS")
        top_chart_registered_user("map_user", states)

    elif question == "Q9. App opens of Map User":
        
        states= st.selectbox("Select the State", Map_user["States"].unique())   
        st.subheader("APPOPENS")
        top_chart_appopens("map_user", states)

    elif question == "Q10. Registered users of Top User":
